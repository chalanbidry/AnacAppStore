...
@Entity
public class ChristianFile implements Serializable {
    ...
    @ManyToOne
    private CategorieChristianFile categorie;
    ...
    public CategorieChristianFile getCategorie() {
        return categorie;
    }

    public void setCategorie(CategorieChristianFile categorie) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ChristianFile)) {
            return false;
        }
        ChristianFile other = (ChristianFile) object;
