...
var CompCharts = function() {
    ...
    return {
        init: function() {
            ...
            // Data for the charts
            var dataEarnings    = [[1, 1000], [2, 2300], [3, 3200], [4, 2500], [5, 4200], [6, 3100], [7, 3600], [8, 2500], [9, 4600], [10, 3700], [11, 4200], [12, 5200]];
            ...
            $.plot(chartMixed,
                [
                    ...
                    },
                    {
                        label: 'Sales',
                        data: dataSales,
                        lines: { show: true, steps: true, fill: true, fillColor: {colors: [{opacity: .4}, {opacity: .4}]} }
                    },
                    {
                        label: 'Tickets',
                        data: dataTickets,
